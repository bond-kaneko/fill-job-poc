module github.com/bond-kaneko/fill-job-poc/river-impl

go 1.25.0

replace github.com/bond-kaneko/fill-job-poc/shared => ../shared

require (
	github.com/bond-kaneko/fill-job-poc/shared v0.0.0-00010101000000-000000000000
